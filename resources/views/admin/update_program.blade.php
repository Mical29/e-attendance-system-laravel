    ...
    <div class="col-md-8">
        ...
        <section class="submitbox border border-gray rounded pl-3 pr-3 pb-3">
            <div class="operations">
                ...
                <form id="programRegForm" action={{ route('programs.update',[$program->id] )}} method=POST enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="operations__content operations__content--1 operations__content--active">
                        <p>
                            ...
                            <input placeholder="E.g Diploma in IT..." name="programname" class="rounded" value="{{$program->program_name}}">
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <img id="programpreview" src="/images/{{$program->program_image}}" alt="program image" /> <br />
                            <input accept="image/*" type='file' id="programimg" name="programimg" class="form-control mt-3" />
                        </p>
                    ...
                    <div class="operations__content operations__content--2">
                        <p>
                            ...
                            <input type="number" name="programfeeslocal" id="programfeeslocal" class="rounded" value="{{$program->domestic_student}}">
                        </p>
                        <p>
                            <label for="programfeesforeign" class="text-muted">For International/New Student</label> <br />
                            <input type="number" name="programfeesforeign" id="programfeesforeign" class="rounded" value="{{$program->international_student}}">
                        </p>
                        <label for="programfeesmessage" class="text-muted">Program Fees Message</label> <br />
                        <textarea id="programfeesmessage" name="programfeesmessage" rows="4" placeholder="Message for the program fees " class="rounded" value="{{$program->program_fees_message}}">{{$program->eligibility_and_requirements}}</textarea>
                    </div>

                    <div class="operations__content operations__content--3">
                        <p class="text-danger">
                            <label for="programRequirement" class="text-muted">Please Describe Requirements of a Student.</label> <br />
                            <textarea id="programRequirement" name="programRequirement" value="{{$program->eligibility_and_requirements}}">{{$program->eligibility_and_requirements}}</textarea>
                        </p>
...
<script type="text/javascript" src="{{ URL::asset('js/bob_program_create.js') }}"></script>
@endsection
